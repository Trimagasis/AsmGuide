...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->перейтиКСборникуТеорииToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Segoe UI", 10.2F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
			this->перейтиКСборникуТеорииToolStripMenuItem->Name = L"перейтиКСборникуТеорииToolStripMenuItem";
			this->перейтиКСборникуТеорииToolStripMenuItem->Size = System::Drawing::Size(244, 27);
