...
namespace ProjectSprv {
	...
	/// <summary>
	/// Ñâîäêà äëÿ Example2Form
	/// </summary>
	public ref class Example2Form : public System::Windows::Forms::Form
	{
	public:
		Example2Form(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Example2Form::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &Example2Form::button1_Click);
			// 
			// panel1
			// 
			...
			this->êÏğèìåğàìToolStripMenuItem->Size = System::Drawing::Size(191, 28);
			this->êÏğèìåğàìToolStripMenuItem->Text = L"Ê ïğèìåğàì";
			this->êÏğèìåğàìToolStripMenuItem->Click += gcnew System::EventHandler(this, &Example2Form::êÏğèìåğàìToolStripMenuItem_Click);
			// 
			// âÌåíşToolStripMenuItem
			// 
			this->âÌåíşToolStripMenuItem->Name = L"âÌåíşToolStripMenuItem";
			this->âÌåíşToolStripMenuItem->Size = System::Drawing::Size(191, 28);
			this->âÌåíşToolStripMenuItem->Text = L"Â ìåíş";
			this->âÌåíşToolStripMenuItem->Click += gcnew System::EventHandler(this, &Example2Form::âÌåíşToolStripMenuItem_Click);
			// 
			// label1
			// 
			...
			this->Name = L"Example2Form";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Àíèìàöèÿ ôèãóğ";
