...
namespace ProjectSprv {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ âÇàäToolStripMenuItem;
	...
	private: System::Windows::Forms::ToolStripMenuItem^ êÂûáîğóÒóòîğèàëàToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->âÇàäToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->êÂûáîğóÒóòîğèàëàToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->label6->Text = L"Äîëæíî âûâåñòè:";
			// 
			// pictureBox3
			// 
			...
			this->label4->Text = L"Íàïèñàíèå ïğîãğàììû\r\n\r\nÏğèìåğ äëÿ âûâîäà Hello, world!\r\n\r\nÂïèñûâàåì ıòîò êîä:";
			// 
			// pictureBox2
			// 
			...
			this->label2->Text = L"Visual Studio Code\r\n\r\nVisual Studio Code ìîæíî ñêà÷àòü ñ îôèöàëüíîãî ñàéòà:\r\nÎòêğ"
				L"îéòå Èíòåğíåò-áğàóçåğ\r\nÂáèâàåì â ïîèñê Visual Studio Code\r\nÏåğåõîäèì íà ñàéò:";
			// 
			// menuStrip1
			// 
			...
			// 
			// âÇàäToolStripMenuItem
			// 
			this->âÇàäToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
				this->êÂûáîğóÒóòîğèàëàToolStripMenuItem,
			...
			// 
			// êÂûáîğóÒóòîğèàëàToolStripMenuItem
			// 
			this->êÂûáîğóÒóòîğèàëàToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Segoe UI", 10.2F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
			this->êÂûáîğóÒóòîğèàëàToolStripMenuItem->Name = L"êÂûáîğóÒóòîğèàëàToolStripMenuItem";
			this->êÂûáîğóÒóòîğèàëàToolStripMenuItem->Size = System::Drawing::Size(254, 28);
			this->êÂûáîğóÒóòîğèàëàToolStripMenuItem->Text = L"Ê âûáîğó Òóòîğèàëà";
			this->êÂûáîğóÒóòîğèàëàToolStripMenuItem->Click += gcnew System::EventHandler(this, &SoftInt2Form::êÂûáîğóÒóòîğèàëàToolStripMenuItem_Click);
			// 
			// âÌåíşToolStripMenuItem
			// 
			this->âÌåíşToolStripMenuItem->Font = (gcnew System::Drawing::Font(L"Segoe UI", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->âÌåíşToolStripMenuItem->Name = L"âÌåíşToolStripMenuItem";
			this->âÌåíşToolStripMenuItem->Size = System::Drawing::Size(254, 28);
			this->âÌåíşToolStripMenuItem->Text = L"Â ìåíş";
			this->âÌåíşToolStripMenuItem->Click += gcnew System::EventHandler(this, &SoftInt2Form::âÌåíşToolStripMenuItem_Click);
			// 
			// SoftInt2Form
			// 
...
private: System::Void êÂûáîğóÒóòîğèàëàToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
