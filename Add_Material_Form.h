...
namespace ProjectSprv {
	...
	/// <summary>
	/// —водка дл€ Add_Material_Form
	/// </summary>
	public ref class Add_Material_Form : public System::Windows::Forms::Form
	{
	public:
		Add_Material_Form(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->назад¬ћенюToolStripMenuItem->Click += gcnew System::EventHandler(this, &Add_Material_Form::назад¬ћенюToolStripMenuItem_Click);
			// 
			// Add_Material_Form
			// 
			...
			this->Name = L"Add_Material_Form";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"ƒоп. теоретический материал";
