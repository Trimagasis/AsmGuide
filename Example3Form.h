...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->êÏğèìåğàìToolStripMenuItem->Click += gcnew System::EventHandler(this, &Example3Form::êÏğèìåğàìToolStripMenuItem_Click);
			// 
			...
			this->âÌåíşToolStripMenuItem->Click += gcnew System::EventHandler(this, &Example3Form::âÌåíşToolStripMenuItem_Click);
			// 
			// label1
			// 
			...
			this->Text = L"Àíèìàöèÿ + ïåğåìåùåíèå ôèãóğû ñ ïîìîùüş êëàâèàòóğû";
